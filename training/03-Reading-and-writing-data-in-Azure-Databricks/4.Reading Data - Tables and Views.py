...
pageviewsBySecondsExampleDF = spark.read.table("hive_metastore.default.pageviews_by_second_example_tsv")
...
# MAGIC %sql
# MAGIC select * from hive_metastore.default.pageviews_by_second_example_tsv limit(5)
